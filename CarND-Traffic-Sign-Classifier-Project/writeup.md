...
These images habe to be resized to 32x32 pixel images before prediction. This reduces the resolution of the original images.
The first image might be difficult to classify because once resized, the shaded vehicles might be too unobvious to be identified. There are also watermarks on the traffic signs in both the first and second images.
